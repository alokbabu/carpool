...
<div class="breadcrump">
	...
	<li><a href = "<?php $_SERVER['SERVER_NAME'] . '/' . $_SERVER['REQUEST_URI']; ?>">Post a Ride</a></li>
</div>
<form method="post" action="<?php echo base_url()."post/add"?>"/>
<div id = "content">
<div id="post_ride_table_wraper">
<table width="200" border="0" cellpadding="2" cellspacing="10">
	<tr>
		<td><span class="select_time" style = "padding:0px;">I am: 	</span> <?php $js = 'id="ddcommutetype" onChange="rider_type_change();"';  echo form_dropdown('ride_type',$commute_type,'rider',$js);?></td>
		<td></td>
	</tr>
  <tr>
<td><input style = "padding-left :8px;" class = "post_ride_textbox" name="txtsource" id="source" type="text" size="50" placeholder="From" autocomplete="on"></td>
  </tr>
  <tr><td><li class="registration_error"><?php echo form_error('txtsource');?></li></td></tr>
  <tr>
  <td><input style = "padding-left :8px;" class = "post_ride_textbox" name="txtdestination" id="destination" type="text" size="50" height="50" placeholder="To" autocomplete="on"></td>
  </tr>
  <tr><td><li class="registration_error"><?php echo form_error('txtdestination');?></li></td></tr>
  <tr>
 <td>
 <input class = "post_ride_textbox" name = "txtdepartdate"  id="departdate" placeholder="Departure date" type = "text" maxlength = "20" >
 <span class="select_time">Select depart time :	</span>
 </td>
 <td>
	<?php echo form_dropdown('txtdeparttime',$departdate,'','class="postdropdown"'); ?>
 </td>
 </tr>
 <tr>
 ...
 <tr>
 <td>
 <input class = "post_ride_textbox"  name= "txtreturndate" class="date"  id="returndate" placeholder="Return Date" type = "text" maxlength = "20" >
 <span class="select_time">Select return time :	</span>
 </td>
 <td>
 <?php
	 $js = 'id="noreturn" class="postdropdown"';
  echo form_dropdown('txtreturntime',$returndate,'anytime',$js); ?>
 </td>
 </tr>
 <tr><td><li class="registration_error"><?php  echo form_error('txtreturndate');?></li></td></tr>
 <tr>
 	<td>
 		<span style = "padding:0px;"class="select_time">No return</span><?php $js = 'id="cbnoreturn"'; echo form_checkbox($no_return,'',false,$js); ?>
 	</td>
 	
 </tr>
 <tr>
 	<td>
 		<span id = "labelseats" style= "padding : 0px;" class="select_time">Available seats  </span><?php $ddpropertes = 'id="ddseats"'; echo form_dropdown('seats',$no_of_seats,'1',$ddpropertes);?>
 	</td>

 </tr>
 <tr>
 	<td>
 		<span style = "padding :0px;"class="select_time">I am a : </span><?php echo form_dropdown('smoker',$smoker,'Nonsmoker'); ?>
 	</td>
 </tr>
 <tr><td><span style= "padding:4px 0px 12px 0px; display:block;" class="select_time">Amount : </span><input style = "width: 220px; padding: 4px 4px; box-shadow: none;" name = "amount" id = "s3" type = "text" class = "post_ride_textbox" maxlength="4" ></td>
 </tr>
...
<td><span style = "padding :0px;"class="select_time">Notes:</span>
 ...
 <tr>
 <td>
<textarea id="notes" cols="40" rows="8" name="txtareanotes" class = "notes"></textarea>
 </td>
 </tr> 
 <tr><td><input id = "btnpostride" class="button" type="submit" name="submit" value="Post this ride"/></td></tr>
</table>
